						...
						<div class="row">
							<div class="col-sm-4">
								<h2 style="color: WHITE">
									<h2 style="color: WHITE">인증 수정할게요!!</h2>
							</div>
							<div class="col-sm-4"></div>
							<div class="col-sm-4">
								<img src="/GarbageCollector/assets/img/certify_update.png"
							...
							<div class="col-md-12">
								...
								<div id="details">
									...
									<textarea class="form-control" rows="5" name="details"
										style="margin: 0px -5px 0px 0px; width: 564px; height: 203px;">"${vo.details}" </textarea>
								</div>
							</div>
						</div>
					</div>
