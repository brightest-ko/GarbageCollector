...
<main>
    ...
    <form method="POST" action="<%=ctxPath%>/helper_add.do" enctype="multipart/form-data">
        <div class="container form-group">
            ...
            <div class="row">
                <div class="form-group col-xs-4" id="helper_photo">
                    <label class="col-form-label ">사진</label> <input type="file"
                                                                     name="helper_photo" camera="camera"
                                                                     class="form-control col-sm-11 "/>
                </div>


                <div class="col-xs-8 w3-padding-24 w3-margin-3">
                    ...
                    <textarea name="message" rows="5" cols="50"
                              ...
                              placeholder="자신에 대해 한마디로 표현해주세요." maxlength="100"></textarea>
                </div>
            </div>
        </div>
        ...
        <div class="clearfix row">
            ...
            <div class="col-xs-3" style="padding: 20px 20px 20px 20px;">
